    ...
    with open(cam_path) as f:
        ...
        if show_hint:
            if default_camera_index < 0:
                default_camera_index = 0
            r, a, e = get_current_radius_azimuth_and_elevation( # camera_position, view_center, observesant_coordinates
                data[default_camera_index]["position"],
                center_view_world_space,
                observant_coordinates,
            )
            print("Default camera ", default_camera_index, " has")
            print("img_name:   ", data[default_camera_index]["img_name"])
            print("azimuth:    ", a)
            print("elevation:  ", e)
            print("radius:     ", r)
