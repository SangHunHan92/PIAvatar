...
class MvRgbDatasetBase(Dataset):
    ...
    def __init__(
        ...
        self.smpl_model = smplx.SMPLX(model_path = config.PROJ_DIR + '/../smpl_models/smplx', gender = 'neutral', use_pca = False, num_pca_comps = 45, flat_hand_mean = True, batch_size = 1)
    ...
    def compute_pca(self, n_components = 10):
        ...
        if not os.path.exists(self.data_dir + '/smpl_pos_map/pca_%d.ckpt' % n_components):
            ...
            # with open(self.data_dir + '/smpl_pos_map/pca_%d.ckpt' % n_components, 'rb') as f:
            #     import pickle
