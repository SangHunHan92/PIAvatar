...
def _initialize_hands(self):
    ...
    smplx_lhand_to_mano_rhand_data = np.load(config.PROJ_DIR + '/../smpl_models/mano/smplx_lhand_to_mano_rhand.npz', allow_pickle = True)
    smplx_rhand_to_mano_rhand_data = np.load(config.PROJ_DIR + '/../smpl_models/mano/smplx_rhand_to_mano_rhand.npz', allow_pickle = True)
    ...
    mano_face_closed = np.loadtxt(config.PROJ_DIR + '/../smpl_models/mano/mano_face_close.txt').astype(np.int64)
